...
class TestSmokeTest():
  ...
  def test_navigatetothehomepage1(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(747, 701)
  ...
  def test_navigatetotheadminpage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(750, 701)
    ...
    self.driver.find_element(By.ID, "username").send_keys("chidinmaobasi43@gmail.com")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("lovely")
  ...
  def test_navigatetothejoinpage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Chidinma")
    self.driver.find_element(By.NAME, "lname").send_keys("Uzoigwe")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Dog World")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Mrs")
    elements = self.driver.find_elements(By.NAME, "submit")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "submit").click()
    self.driver.find_element(By.NAME, "email").click()
    self.driver.find_element(By.NAME, "email").send_keys("chidinmaobasi43@gmail.com")
    self.driver.find_element(By.NAME, "cellphone").click()
    self.driver.find_element(By.NAME, "cellphone").send_keys("703-304-0949")
